...
2. Access the running container
    ...
    ```
3. Run the tests in the running container
    ```bash
    $ docker exec -it django_app python3 manage.py test
    ```
4. Access django shell in the running container
    ```bash
